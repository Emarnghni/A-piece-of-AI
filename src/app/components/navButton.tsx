      ...
      >
        <div className="expandable w-screen justify-evenly px-8  lg:flex lg:h-full lg:w-full lg:flex-row lg:items-center lg:justify-between lg:gap-14 lg:bg-transparent lg:px-0">
          <div className="flex flex-col-reverse gap-y-14 lg:w-[70%] lg:flex-row-reverse lg:justify-between">
            <a
              className={`hover nav text-base font-medium md:text-xl lg:block lg:text-sm ${isOpen ? "open" : ""}`}
              href="#"
            >
              درباره ما
            </a>
          ...
          >
            <a
              href="#"
              className=" rounded-4xl bg-accsent px-6 py-4 text-center text-base font-medium text-white md:flex-grow md:rounded-3xl md:px-8 md:py-4 md:text-lg lg:flex-grow-0 lg:px-6 lg:py-2 lg:text-xs"
            >
              دکمه اول
            </a>
            <a
              href="#"
              className="rounded-4xl bg-[#806ff1] px-6 py-4 text-center text-base font-medium text-white md:flex-grow md:rounded-3xl md:px-8 md:py-4 md:text-lg lg:flex-grow-0 lg:px-6 lg:py-2 lg:text-xs"
            >
              دکمه دوم
            </a>
          </div>
